...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {M.S. in Electrical Engineering, GPA: 4.16/4.30}{Taipei, Taiwan}
    \resumeSubheading
      {National Yang Ming Chiao Tung University (NYCU)}{Sep 2020 -- Jun 2024}
      {B.S. in Computer Science, GPA: 4.28/4.30, Rank: 2/201 (top 1\%)}{Hsinchu, Taiwan}
...
\section{Publications}
  \resumeSubHeadingListStart
    \resumeItemPlain{\textbf{Y.-C. Huang}, P.-C. Hsiu, R. Fang, and M.-S. Chen, ``KV Admission: Learning What to Write for Efficient Long-Context LLM Inference,'' \textit{EMNLP}, 2026.}
    \resumeItemPlain{C.-Y. Liu, H. R. Mendis, \textbf{Y.-C. Huang}, Y.-J. Chen, and P.-C. Hsiu, ``Splitting Bottlenecks: Memory-Aware Neural Architecture Search for Multi-Branch TinyML,'' \textit{IEEE TCAD}, 2026.}
    \resumeItemPlain{\textbf{Y.-C. Huang}, C.-P. Yang, and T. T. Yeh, ``AQB8: Energy-Efficient Ray Tracing Accelerator through Multi-Level Quantization,'' \textit{ISCA}, 2025.}
  \resumeSubHeadingListEnd
